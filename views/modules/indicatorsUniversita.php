...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Gestione Indicatori Università
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <table class="table table-hover table-bordered table-striped dt-responsive indicatorsUniversitaTable" width="100%">
                    <thead>
                    <tr>
        ...
        <div class="modal-content">
            <form role="form" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="box-body">
                        <!--Input name -->
                        <div style="font-size: large">Nome</div>
                        ...
                        <!-- input Target -->
                        <div style="font-size: large">Target</div>
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <select class="form-control input-lg" id="newTarget" name="newTarget">
                                    ...
                                    $item = null;
                                    $value1 = null;
                                    $targets = ControllerTargetUniversita::ctrShowTargetsUniversita($item, $value1);
            ...
            <?php
            $createIndicator = new ControllerIndicatorsUniversita();
            $createIndicator->ctrCreateIndicatorUniversita();
            ?>
        </div>
    </div>
</div>
...
<!-- Modal -->
<div id="modalEditIndicatorUniversita" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" method="POST" enctype="multipart/form-data">
                <!--=====================================
    ...
    <?php
    $editIndicator = new ControllerIndicatorsUniversita();
    $editIndicator->ctrEditIndicatorUniversita();
    ?>
    </form>
</div>
</div>
...
<?php
$deleteIndicator = new ControllerIndicatorsUniversita();
$deleteIndicator->ctrDeleteIndicatorUniversita();
?>
